        ...
        stage ('upload to master') {
            steps {
                script {
                    sh ''' 
                    cd /jenkins/version
                    git remote set-url origin https://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:karthikthama@github.com/karthikthama/my-repo-db.git
