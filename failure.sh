#!/bin/bash
comm -23 <(sort /jenkins/checksum/OUTPUT2.txt) <(sort /jenkins/checksum/OUTPUT1.txt) >> /jenkins/checksum/MISMATCHEDOUTPUT.txt
while read line
do
$line=$(comm -23 <(sort /jenkins/checksum/OUTPUT2.txt) <(sort /jenkins/checksum/OUTPUT1.txt))
...
done < /jenkins/checksum/MISMATCHEDOUTPUT.txt
